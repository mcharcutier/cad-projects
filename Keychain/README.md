...
*Fig. 4: Keychain v.1.2. Increased the thickness of the keyring loop. Printer was not cooperating for 2/3 prints, as it stagnated near the loop, making a blob and started to clog the nozzle. Worked the third iteration. 
...
*Fig. 5: Wanted to observe if the prints the day before were a fluke. Further troubleshooting resolved the print issue, and ready for daily use.*
